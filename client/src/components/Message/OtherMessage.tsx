...
interface IOtherMessageForwardRefProps {
  message: string;
}

const OtherMessageForwardRef: ForwardRefRenderFunction<
  HTMLDivElement,
  IOtherMessageForwardRefProps
> = ({ message }, ref) => {
...
export const OtherMessage = forwardRef(OtherMessageForwardRef);
